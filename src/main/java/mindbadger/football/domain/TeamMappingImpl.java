...
public class TeamMappingImpl implements TeamMapping, Serializable {
	...
	public TeamMappingImpl () {
	}
	
	public TeamMappingImpl (String dialect, Integer sourceId, Integer fraId) {
